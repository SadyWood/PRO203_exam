...
{/* TODO: Bildet og info bør komme fra backend, ikke hardkodet */}
      <View style={styles.headerCard}>
        ...
        <View style={styles.headerTextBox}>
          ...
          <Text style={styles.dateText}>05.05.2023</Text>
        </View>
      ...
      <View style={styles.departmentBar}>
        <Text style={styles.departmentText}>Avdeling: Loppe</Text>
      </View>
      ...
      <View style={styles.healthCard}>
        ...
        <View style={styles.healthGroup}>
          ...
          <View style={styles.healthRow}>
            <Text style={styles.healthRowText}>Gluten</Text>
          </View>

          <View style={styles.healthRow}>
            <Text style={styles.healthRowText}>Peanøtter</Text>
          </View>
        </View>
        ...
        <View style={styles.healthGroup}>
          ...
          <View style={styles.healthRow}>
            <Text style={styles.healthRowText}>Allergisk mot pels</Text>
          </View>
        </View>
      </View>
